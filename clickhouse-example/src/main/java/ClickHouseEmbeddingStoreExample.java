...
import dev.langchain4j.store.embedding.clickhouse.ClickHouseEmbeddingStore;
import org.testcontainers.clickhouse.ClickHouseContainer;

import java.util.List;

public class ClickHouseEmbeddingStoreExample {

    public static void main(String[] args) throws InterruptedException {

        try (ClickHouseContainer clickHouse = new ClickHouseContainer("clickhouse/clickhouse-server")
